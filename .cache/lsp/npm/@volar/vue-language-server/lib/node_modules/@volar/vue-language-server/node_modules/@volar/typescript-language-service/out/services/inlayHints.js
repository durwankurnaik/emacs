...
function register(languageService, getTextDocument, getConfiguration, ts) {
    return (uri, range) => __awaiter(this, void 0, void 0, function* () {
        const document = getTextDocument(uri);
        if (!document)
            return;
        const preferences = yield (0, getUserPreferences_1.getUserPreferences)(getConfiguration, document.uri);
