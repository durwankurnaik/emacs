...
function register(rootUri, languageService, getTextDocument) {
    ...
    function fromProtocolCallHierarchyItem(item) {
        ...
        const detail = useFileName ? upath.relative(rootPath, upath.dirname(item.file)) : (_c = item.containerName) !== null && _c !== void 0 ? _c : '';
        const result = {
