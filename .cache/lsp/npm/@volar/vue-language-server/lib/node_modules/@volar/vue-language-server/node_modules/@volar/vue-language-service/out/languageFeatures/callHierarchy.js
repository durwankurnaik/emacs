...
function register(context) {
    ...
    function transformCallHierarchyItem(tsItem, tsRanges) {
        ...
        const vueItem = Object.assign(Object.assign({}, tsItem), { name: tsItem.name === upath.basename(shared.getPathOfUri(sourceMap.mappedDocument.uri)) ? upath.basename(shared.getPathOfUri(sourceMap.sourceDocument.uri)) : tsItem.name, uri: sourceMap.sourceDocument.uri, range: vueRange, selectionRange: vueSelectionRange });
