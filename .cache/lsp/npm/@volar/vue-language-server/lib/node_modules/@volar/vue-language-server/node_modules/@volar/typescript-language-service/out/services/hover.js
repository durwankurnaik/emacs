...
function register(rootUri, languageService, getTextDocument, getTextDocument2, ts) {
    return (uri, position, documentOnly = false) => {
        ...
        const documentation = previewer.markdownDocumentation((_a = info.documentation) !== null && _a !== void 0 ? _a : [], info.tags, { toResource }, getTextDocument2);
